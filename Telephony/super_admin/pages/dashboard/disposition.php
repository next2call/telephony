...
$usersql2 = "SELECT * FROM `dispo` WHERE admin IN ('$admin_user_list')"; 
    ...
    if (mysqli_num_rows($quer_check) > 0) {
        ...
        window.onload = function() {
            Swal.fire({
                ...
                window.location.href = "'.$admin_ind_page_s.'?c=dashboard&v=disposition";
            });
        };                
        </script>';
    } else{    
                    ...
                    <div class="row">
                        <div class="my-input-with-help col-12">
                            <div class="form-group my-input">
                                <!-- <textarea type="text" class="form-control" id="new-user-number" name="user"
                                       aria-describedby="new-user-no" required></textarea>
                                <label for="new-user-number">Tipe disposition</label> -->
