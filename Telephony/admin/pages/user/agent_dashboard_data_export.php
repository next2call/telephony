...
if(!empty($from_date) && !empty($to_date)){
    ...
    $sql = "SELECT id, user_name, log_in_time, log_out_time, status FROM login_log WHERE DATE(log_in_time) BETWEEN '$from_date' AND '$to_date' AND user_name='$user_id' ORDER BY id DESC";

}elseif(!empty($user_id)){

    $sql = "SELECT id, user_name, log_in_time, log_out_time, status FROM login_log WHERE user_name='$user_id' ORDER BY id DESC";
