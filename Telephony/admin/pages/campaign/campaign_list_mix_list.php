...
$campaign = new campaign();
 $sql = "SELECT * FROM `compaign_list` WHERE admin='$Adminuser' ORDER BY id DESC";
// die();
...
//    $select1 = "SELECT * FROM compaign_list WHERE compaign_id='$campaign_id'";
    $select1 = "SELECT compaign_list.* FROM compaign_list JOIN users ON users.admin=compaign_list.admin WHERE compaign_list.compaign_id='$campaign_id' AND compaign_list.admin='$Adminuser'";
...
// Create the SQL query string
  $sql_New = "INSERT INTO `compaign_list` (
    ...
    '$script_id', '$get_call_launch', '$Adminuser', '$ring_time', 
...
$uupdate = mysqli_query($con, $update_camp);
...
//    echo "</br>";
    ...
    $auto_dial_level = $row_camp['auto_dial_level'];
    ...
    if(mysqli_fetch_assoc($sel_query1) > 0){
        ...
        $ins_ddata = "INSERT INTO `compaign_list`(`compaign_id`, `compaignname`, `campaign_number`, `outbond_cli`, `campaign_dis`, `creat_date`, `status`, `music_on_hold`, `welcome_ivr`, `after_office_ivr`, `local_call_time`, `week_off`, `script_notes`, `get_call_lunch`, `admin`, `ring_time`, `agent_number`, `type`, `auto_dial_level`) VALUES ('$campaign_id','$campaign_name','$campaign_number','$outbond_cli','$campaign_dis','$date','$status','$music_on_hold','$welcome_ivr','$after_office_ivr','$local_call_time','$week_off','$script_notes','$get_call_lunch','$Adminuser','$ring_time','$agent_number','$type','$auto_dial_level')";
    //    die();
            ...
            <table class="all-user-table table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col">INBOUND  DID.</th>
                        <th scope="col">OUTBOUND DID.</th>
                 ...
                 if($group_ivr == '1'){ ?>
                        ...
                        <img src="../assets/images/common-icons/assign_agent.png" alt="add_icon"
                            ...
                            if (isset($row['welcome_ivr']) || isset($row['no_agent_ivr']) || $row['music_on_hold'] || $row['after_office_ivr']) { ?>
                             <img src="https://103.113.27.163/Telephony/admin/pages/campaign/Cancel.png" class="cursor_p remove_IVR mb-2" data-toggle="modal"
