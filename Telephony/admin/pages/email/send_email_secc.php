    ...
    <div class="show-users ml-5">
        ...
        <div class="table-responsive my-table ml-5">
            <div class="table-top d-flex">
                <a class="data_btn" href="#create-email" data-toggle="modal" data-target="#create-email">
                    <i class="fa fa-plus-circle" aria-hidden="true"></i> Create Email
                </a>
...
<!-- <script>
    function saveData() {
        ...
        $.ajax({
            type: 'POST',
            url: "pages/email/data_save.php", // Replace with your actual server-side URL
            data: formData,
            processData: false,
            contentType: false,
            success: function (response) {
