...
<div class="ml-5">
  ...
  <div class="total-stats">
    ...
    <a href="" class="arrow-icon" onclick="return navigateToContactUpload();">
        <i class="fas fa-arrow-left arrow-icon"></i>
      </a>
      <h3 style="margin-left: 10px; ">Total Upload Data</h3>
    </div>
      ...
      <div class="select">
        ...
        <button class="btn btn-info" data-toggle="modal" data-target="#editAgentModal_one">
          Data Churning</button>
    ...
    <script>
    function navigateToContactUpload() {
...
<script type="text/javascript">
  ...
  jQuery(document).ready(function ($) {
    ...
    $('#employee_grid').DataTable({
      ...
      "serverSide": true,
      "ajax": {
        url: "pages/dashboard/datatables-ajax/ajax_upload_data_all.php", // PHP script that fetches data
    ...
    $('#delete_this_data').on('click', function () {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location.href = "pages/new_action/contact_remove.php?dial_status=all"; // Redirect with the ID query string
        }
      });
    });
  });
