...
$agentid = $_SESSION['new_get_uuser'];
...
if ($serch_type == 'date') {
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             WHERE DATE(cdr.start_time) BETWEEN '$fromdate' AND '$todate' AND cdr.admin = '$Adminuser' $condition_one");
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             LEFT JOIN users ON users.user_id = cdr.call_to 
                             LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
                             WHERE DATE(cdr.start_time) BETWEEN '$fromdate' AND '$todate' AND cdr.admin = '$Adminuser' $condition_one $searchQuery");
  $records = mysqli_fetch_assoc($sel);
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             LEFT JOIN users ON users.user_id = cdr.call_to 
                             LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
                             WHERE (cdr.call_from='$agentid' OR cdr.call_to='$agentid') AND cdr.admin = '$Adminuser' $condition_one");
  $records = mysqli_fetch_assoc($sel);
  $totalRecords = isset($records['allcount']) ? $records['allcount'] : 0;
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             LEFT JOIN users ON users.user_id = cdr.call_to 
                             LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
                             WHERE (cdr.call_from='$agentid' OR cdr.call_to='$agentid') AND cdr.admin = '$Adminuser' $condition_one $searchQuery");
  $records = mysqli_fetch_assoc($sel);
  $totalRecordwithFilter = isset($records['allcount']) ? $records['allcount'] : 0;
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             LEFT JOIN users ON users.user_id = cdr.call_to 
                             LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
                             WHERE DATE(cdr.start_time) BETWEEN '$fromdate' AND '$todate' AND (cdr.call_from='$agentid' OR cdr.call_to='$agentid') AND cdr.admin = '$Adminuser' $condition_one");
  $records = mysqli_fetch_assoc($sel);
  $totalRecords = isset($records['allcount']) ? $records['allcount'] : 0;
  ...
  $sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
                             ...
                             LEFT JOIN users ON users.user_id = cdr.call_to 
                             LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
                             WHERE DATE(cdr.start_time) BETWEEN '$fromdate' AND '$todate' AND (cdr.call_from='$agentid' OR cdr.call_to='$agentid') AND cdr.admin = '$Adminuser' $condition_one $searchQuery");
  $records = mysqli_fetch_assoc($sel);
  $totalRecordwithFilter = isset($records['allcount']) ? $records['allcount'] : 0;
  ...
  LEFT JOIN users ON users.user_id = cdr.call_to 
  LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
  WHERE (cdr.call_from='$agentid' OR cdr.call_to='$agentid') $condition_one");
$records = mysqli_fetch_assoc($sel);
$totalRecords = isset($records['allcount']) ? $records['allcount'] : 0;
...
$sel = mysqli_query($con, "SELECT COUNT(*) as allcount 
  ...
  LEFT JOIN users ON users.user_id = cdr.call_to 
  LEFT JOIN compaign_list ON compaign_list.compaign_id = users.campaigns_id 
  WHERE (cdr.call_from='$agentid' OR cdr.call_to='$agentid') $condition_one $searchQuery");
$records = mysqli_fetch_assoc($sel);
$totalRecordwithFilter = isset($records['allcount']) ? $records['allcount'] : 0;
